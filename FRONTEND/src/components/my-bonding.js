...
const MyBonding = () => {
  ...
  useEffect(() => {
    ...
    if (token) {
      try {
        ...
        setUser({ firstName: decodedToken.FirstName, surName: decodedToken.SurName });
  ...
  const fetchBondingDetails = async () => {
    try {
      const response = await axios.get(`http://localhost:3001/bonding/user/${userId}`);
  ...
  const saveChanges = async () => {
    try {
      ...
      const response = await axios.put(`http://localhost:3001/bonding/${bonding.id}`, bonding);
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-grow container mx-auto p-4">
        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          <h2 className="text-xl font-semibold mb-2">Bonding Information For</h2>
          <span className="mb-2">{user?.firstName} {user?.surName}</span>
          {bonding ? (
            <div className="flex mt-4 space-x-4">
              <button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" onClick={openViewModal}>
                View Details
              </button>
              <button className="bg-green-500 text-white px-4 py-2 rounded hover:bg-green-600" onClick={openEditModal}>
                Edit Bonding
              </button>
            </div>
          ) : (
        ...
        <Modal isOpen={viewModalOpen} onRequestClose={closeViewModal} contentLabel="View Bonding Details" style={customStyles}>
          <h2 className="text-2xl mb-4">Bonding Details</h2>
          {bonding ? (
            <>
              <span>Full Name: {bonding.firstName} {bonding.surName}</span>
              ...
              <p>Guardian Physical Address: {bonding?.guardianPhysicalAddress}</p>
        ...
        >
          ...
          <div className="border-2 border-indigo-600 rounded-lg p-4">
            <h3 className="text-xl mb-2">
              {stage === 1 ? 'Stage 1: Personal Details' 
                  :  stage === 2
              ...
              <div>
               ...
               <label>Sur Name:</label>
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, surName: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, dateOfBirth: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  type="text"
                  value={bonding.sex}
                  onChange={(e) => setBonding({ ...bonding, sex: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, homeVillage: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  type="text"
                  value={bonding.TA}
                  onChange={(e) => setBonding({ ...bonding, TA: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, phoneNumber: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
              </div>
            ...
            {stage === 2 && bonding && (
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, University: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
               ...
               <label>Year Of Study:</label>
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, YearOfStudy: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, ProgramOfStudy: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, email: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, RegNo: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                </div>
            )}
            ...
            {stage === 3 && bonding && (
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, guardianFullName: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
               ...
               <label>Guardian Phone Number:</label>
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, guardianPhoneNumber: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, guardianPostalAddress: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, guardianPhysicalAddress: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, guardianHomeVillage: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, guardianDistrict: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, guardianOccupation: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
              </div>
            ...
            {stage === 4 && bonding && (
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, bankName: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
               ...
               <label>Branch:</label>
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, branch: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, accountName: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, accountNumber: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                </div>
            )}
  ...
  <div>
    ...
    <input
      ...
      onChange={(e) => setBonding({ ...bonding, nationalId: e.target.value })}
      className="border p-2 rounded mb-4 w-full"
    />
    ...
    <input
      ...
      onChange={(e) => setBonding({ ...bonding, studentId: e.target.value })}
      className="border p-2 rounded mb-4 w-full"
    />
    ...
    />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, tuitionAmount: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
               ...
               <label>Upkeep Amount:</label>
                <input
                  ...
                  onChange={(e) => setBonding({ ...bonding, upkeepAmount: e.target.value })}
                  className="border p-2 rounded mb-4 w-full"
                />
                  </div>
                )}
            ...
            <div className="flex justify-between mt-4">
              {stage > 1 && <button onClick={prevStage} className="bg-yellow-500 text-white px-4 py-2 rounded-md">Previous</button>}
              {stage < 6 ? <button onClick={nextStage} className="bg-yellow-500 text-white px-4 py-2 rounded-md">Next</button> : <button onClick={saveChanges} className="bg-yellow-500 text-white px-4 py-2 rounded-md">Save</button>}
            </div>
          </div>
        </Modal>
      </div>
